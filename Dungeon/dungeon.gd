...
const LEVEL_2_SKELETON_SCENE: PackedScene = preload("res://Enemy/skeleton/skeleton.tscn")
const LEVEL_1_BOMB_SCENE: PackedScene = preload("res://Level1Bomb/Level1Bomb.tscn")
const FINAL_BOSS_SCENE: PackedScene = preload("res://Enemy/finalBoss/final_boss.tscn")
...
func _ready() -> void:
	...
	# Add on-screen Menu/Pause button- Ng Poh Hui 2204747
	...
	# Gold Coin HUD counter display- Ng Poh Hui 2204747
